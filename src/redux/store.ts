...
export type StoreType = {
    ...
    addPost: ()=> void
    addMessages: ()=> void
    updateProfileMessage: (textareaValue: string)=> void
    updateDialogMessage: (textareaValue: string) => void
...
export const store: StoreType = {
   _state: {
    ...
    updateProfileMessage(textareaValue: string) {
        this._state.profilePage.profileMessage = textareaValue
        this._callSubscriber(store._state)
    },
    updateDialogMessage(textareaValue: string) {
        this._state.dialogsPage.dialogMessage = textareaValue
        this._callSubscriber(store._state)
    },
